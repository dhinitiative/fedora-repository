...
export IP_ADDR=`hostname -i`                        # IP address of this server (ifconfig -a). 
#
# Software versions
#
...
cat $REPOSITORY_HOME/installation-details.txt | mail -s "Your FEDORA COMMONS server ($SERVER_FULL_NAME)" $ADMIN_EMAIL
